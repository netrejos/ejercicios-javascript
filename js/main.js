...
function multiplicacion(){
    ...
    r=a*b;
    alert("El resultado de la multiplicación es "+r)   
}
function division(){
    var a;
    var b;
    ...
    r=a/b;
    alert("El resultado de la división es "+r)   
}
function numMayor(){
    var a;
    var b;
...
function numMenor(){
    ...
    if(a==b && b==c){
        alert("No hay número menor, los tres son iguales");
    }
    else if (a<=b && a<=c){
...
function determinarNum(){
    ...
    num=parseInt(prompt("POR FAVOR INGRESE EL NÚMERO"));
    if(num % 2 == 0){
